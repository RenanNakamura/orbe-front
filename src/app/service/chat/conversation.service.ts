...
export class ConversationService {
  ...
  getMessages(conversationId: string, cursor?: string, limit: number = 20): Observable<Message[]> {
    let params = new HttpParams()
      .set('limit', limit.toString());
    ...
    return this._http.get<Message[]>(`${environment.chat}${this._api}/${conversationId}/messages`, {params});
  }
}
