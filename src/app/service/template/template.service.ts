...
export class TemplateService {
  ...
  create(template: Template) {
    return firstValueFrom(this._http.post(`${environment.buddy}${this._api}`, template));
  }

  update(template: Template) {
    return firstValueFrom(this._http.patch(`${environment.buddy}${this._api}/${template.id}`, template));
  }
