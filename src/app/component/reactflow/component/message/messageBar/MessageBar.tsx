...
function MessageBar(props: Props) {
    ...
    return (
        <div className={`f-message-bar flex xyflow-node-background-color p-2 ${props?.cssClass}`} autoFocus={false}>
            <div className={'flex flex-row w-full items-end'}>
                        ...
                        <div className={'flex flex-row w-full'}>
                            {message.type === 'IMAGE' && (
                                <div className={`${!fileValidation.success ? 'flex flex-col w-full' : 'w-full'}`}>
                                    <img className={'media'} src={message?.link} alt=''/>
                            ...
                            {message.type === 'VIDEO' && (
                                <div className={`${!fileValidation.success ? 'flex flex-col w-full' : 'w-full'}`}>
                                    <video className={'media'} src={message.link} controls></video>
                                    {!fileValidation.success && (
                                        <div className={'text-red-600 mb-1 text-sm'}>
                                            {getFileValidationMessage()}
                                        </div>
                            ...
                            {message.type === 'DOCUMENT' && (
                                <div className={`${!fileValidation.success ? 'flex flex-col w-full' : 'w-full'}`}>
                                    <embed className={'media'} src={message.link}/>
                                    {!fileValidation.success && (
                                        <div className={'text-red-600 mb-1 text-sm'}>
                                            {getFileValidationMessage()}
                                        </div>
                ...
                {showEmojiPicker && (
                    <div className='absolute mb-6 emoji-picker z-10 nodrag nopan nowheel'>
