    ...
    <div className={'reactflow-section xyflow-node-background-color flex flex-col pb-2'}>
      <div className={'flex flex-row'}>
        <div className={'flex flex-col w-full p-2'}>
          ...
          <input
            type='text'
            className='rounded-md mt-1 p-1 bg-white border-none outline-none nodrag nopan nowheel'
      ...
      <div>
        {
          rows?.map((row, i) => (
            <div className={'relative flex flex-row border-none bg-gray-200 rounded-md p-3 m-2'} key={row.id}>
              <div className={'w-full flex flex-row'}>
                <div className={'flex flex-col w-full'}>
                  <div className={'flex flex-col'}>
                    <label className={'text-xs'}>{rowTitleLabel}</label>
                    <input type='text'
                           className={'rounded-md bg-white p-1 border-none outline-none nodrag nopan nowheel'}
