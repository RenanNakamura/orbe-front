...
import { MdCallSplit, MdFlashOn, MdFormatListBulleted, MdMessage, MdQuestionMark, MdSchedule, MdSmartButton } from 'react-icons/md';
                ...
                <div>
                    ...
                    <div className={'other pb-4 pl-4 pr-4'}>
                        ...
                        <div className={'flex flex-row flex-wrap'}>
                            ...
                            <div
                                className={'min-w-24 p-2 cursor-pointer border-2 border-orange-600 flex flex-col ml-1 mr-1 mb-2 items-center rounded-lg'}
                                onClick={() => onSelectNode(data?.id, NodeType.TIME_INTERVAL)}>
                                <MdSchedule className={'text-orange-600'} size={32} />
                                <span className={'text-orange-600'}>{t('timeIntervalNode.title')}</span>
                            </div>
                        </div>
                    </div>
                </div>
